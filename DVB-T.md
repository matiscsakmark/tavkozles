...
**Felelős személy:** Matiscsák Márk  
...
**Antenna típusa:** Iskra  P-58 L700  
...
| Paraméter                            | Érték            |
|---------------------------------------|------------------|
| Adó frekvencia                        | 634.0 MHz          |
| Sávszélesség                          | 8 MHz            |
| Moduláció típusa                      | QPSK, 8K, 1/32  |
| Jelerősség (RSSI)                     | 51.1 dBu         |
| MER (Modulation Error Ratio)          | 28.8 dB          |
| Noise Margin                          | 24.8             |
| Hiba nélkül vett adás időtartama     | 470 sec          |
...
- **Jelerősség:** A mért jelerősség 51.1 dBu. Ez az érték stabil volt 470 másodperces időtartam alatt, és megfelel a DVB-T előírásoknak. A mérési helyen a jel optimális volt.
